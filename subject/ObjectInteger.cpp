...
namespace goat {
	...
	ObjectInteger::Proto::Proto() {
		...
		objects.insert(createIndex("/="), OperatorDiv::getInstance()->toContainer());
		objects.insert(createIndex("%"), OperatorMod::getInstance()->toContainer());
		objects.insert(createIndex("%="), OperatorMod::getInstance()->toContainer());
		...
		objects.insert(createIndex("!"), OperatorLogicalNot::getInstance()->toContainer());
		objects.insert(createIndex("<<"), OperatorLeftShift::getInstance()->toContainer());
		objects.insert(createIndex("<<="), OperatorLeftShift::getInstance()->toContainer());
		objects.insert(createIndex(">>"), OperatorSignedRightShift::getInstance()->toContainer());
		objects.insert(createIndex(">>="), OperatorSignedRightShift::getInstance()->toContainer());
		objects.insert(createIndex(">>>"), OperatorZeroFillRightShift::getInstance()->toContainer());
		objects.insert(createIndex(">>>="), OperatorZeroFillRightShift::getInstance()->toContainer());
		objects.insert(createIndex("&"), OperatorAnd::getInstance()->toContainer());
		objects.insert(createIndex("&="), OperatorAnd::getInstance()->toContainer());
		objects.insert(createIndex("^"), OperatorXor::getInstance()->toContainer());
		objects.insert(createIndex("^="), OperatorXor::getInstance()->toContainer());
